...
> 개인 실험 프로젝트입니다. 적극적인 개발을 중단했으며, 소스는 MIT 라이선스로 공개합니다.
...
[베타 다운로드](https://github.com/shakystar/agent-company/releases) · [오류 및 개선 제안](https://github.com/shakystar/agent-company/issues)
...
[Windows 베타 1 다운로드](https://github.com/shakystar/agent-company/releases/tag/v0.1.0-beta.1)에서 설치 EXE와 SHA-256 검증 파일을 제공합니다.
...
오류와 개선 제안은 [Issues](https://github.com/shakystar/agent-company/issues)에 등록할 수 있습니다. 로그와 화면에는 인증 정보와 개인 업무 내용이 포함되지 않도록 확인해 주시기 바랍니다.

## 저장소 안내

앱 소스 코드와 설치 파일을 함께 공개하는 저장소입니다. 앱 코드는 [MIT 라이선스](LICENSE)로 제공합니다. 포함된 외부 구성요소에는 각 구성요소의 라이선스와 고지가 적용됩니다.

`main`에는 개발 중단 시점의 소스가 포함됩니다. 2026-09-20 처음 게시한 소스는 당시 개발 작업 폴더의 스냅샷이며, 기존 `v0.1.0-beta.1` 설치 파일과 동일한 소스 버전으로 검증된 것은 아닙니다.
